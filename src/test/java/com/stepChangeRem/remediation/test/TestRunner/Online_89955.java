...
@CucumberOptions(
        plugin = { "pretty", "html:target/cucumber-reports/CucumberhmtlReport",
                ...
                "com.vimalselvam.cucumber.listener.ExtentCucumberFormatter:target/cucumber-reports/report.html,89963_Online_Sole_ Register_After_Income_Payment_Suspension.feature"
        },
        monochrome = true,
